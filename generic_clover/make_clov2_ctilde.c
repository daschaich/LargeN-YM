...
#ifdef SF
           if( s->t==1 || s->t==nt-1 ) {
	      clov_diag[i].di[0][j] += 2*kappa*delta_ctilde;
              clov_diag[i].di[0][j+DIMF] += 2*kappa*delta_ctilde;
              clov_diag[i].di[1][j] += 2*kappa*delta_ctilde;
              clov_diag[i].di[1][j+DIMF] += 2*kappa*delta_ctilde;
            }
#endif
	}
