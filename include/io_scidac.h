...
void save_random_state_scidac_from_site(char *filename,
                                        char *filexml, char *recxml,
                                        int volfmt, field_offset src);
...
void save_real_scidac_from_site(char *filename,
                                char *filexml, char *recxml, int volfmt,
                                field_offset src, int count);
...
// NCOL-dependent stuff
#if NCOL == 2
int read_F2_V_to_site(QIO_Reader *infile, QIO_String *xml_record_in,
                      field_offset dest, int count);
int read_F2_M_to_site(QIO_Reader *infile, QIO_String *xml_record_in,
                      field_offset dest, int count);
int read_F2_D_to_site(QIO_Reader *infile, QIO_String *xml_record_in,
                      field_offset dest, int count);

int read_F2_V_to_field(QIO_Reader *infile, QIO_String *xml_record_in,
                       vector *dest, int count);
int read_F2_M_to_field(QIO_Reader *infile, QIO_String *xml_record_in,
                       matrix *dest, int count);

int read_D2_V_to_site(QIO_Reader *infile, QIO_String *xml_record_in,
                      field_offset dest, int count);
int read_D2_M_to_site(QIO_Reader *infile, QIO_String *xml_record_in,
                      field_offset dest, int count);

int read_D2_V_to_field(QIO_Reader *infile, QIO_String *xml_record_in,
                       vector *dest, int count);
int read_D2_M_to_field(QIO_Reader *infile, QIO_String *xml_record_in,
                       matrix *dest, int count);

int write_F2_V_from_site(QIO_Writer *outfile,
                         QIO_String *xml_record_out,
                         field_offset src, int count);
int write_F2_D_from_site(QIO_Writer *outfile,
                         QIO_String *xml_record_out,
                         field_offset src, int count);
int write_F2_M_from_site(QIO_Writer *outfile,
                         QIO_String *xml_record_out,
                         field_offset src, int count);

int write_D2_V_from_site(QIO_Writer *outfile,
                         QIO_String *xml_record_out,
                         field_offset src, int count);
int write_D2_D_from_site(QIO_Writer *outfile,
                         QIO_String *xml_record_out,
                         field_offset src, int count);

int write_F2_V_timeslice_from_site(QIO_Writer *outfile,
                                   QIO_String *xml_record_out,
                                   field_offset src, int count, int t0);
int write_F2_D_timeslice_from_site(QIO_Writer *outfile,
                                   QIO_String *xml_record_out,
                                   field_offset src, int count, int t0);

int write_D2_V_timeslice_from_site(QIO_Writer *outfile,
                                   QIO_String *xml_record_out,
                                   field_offset src, int count, int t0);
int write_D2_D_timeslice_from_site(QIO_Writer *outfile,
                                   QIO_String *xml_record_out,
                                   field_offset src, int count, int t0);

int write_F2_V_from_field(QIO_Writer *outfile,
                          QIO_String *xml_record_out, vector *src, int count);
int write_F2_M_from_field(QIO_Writer *outfile,
                          QIO_String *xml_record_out, matrix *src, int count);

int write_D2_V_from_field(QIO_Writer *outfile,
                          QIO_String *xml_record_out, vector *src, int count);

int write_F2_V_timeslice_from_field(QIO_Writer *outfile,
                                    QIO_String *xml_record_out,
                                    vector *src, int count, int t0);

int write_D2_V_timeslice_from_field(QIO_Writer *outfile,
                                    QIO_String *xml_record_out,
                                    vector *src, int count, int t0);
#endif
#if NCOL == 3
