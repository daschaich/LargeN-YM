...
int r_serial_ks_to_field(ks_prop_file *kspf, int color, vector *src);
...
void w_serial_ks_from_field(ks_prop_file *kspf, int color, vector *src);
...
void w_serial_ks_fm_from_field(ks_prop_file *kspf, vector *prop);
...
int r_serial_ks_fm_to_field(ks_prop_file *kspf, vector *prop);
